...
var Widget_Wizard = function () {
    ...
    return {
        ...
        load_next_widget: function (form_wizard_id, partialview_url, dashboard_id, chart_type, widget_title, widget_id, chart_id) {
            ...
            if ($form.valid()) {
                ...
                if (form_wizard_id == 1) {
                    $.ajax({
                        url: partialview_url,
                        data: { 'dashboard_Id': dashboard_id, 'chart_type': chart_type, 'widget_title': widget_title, 'widget_Id': widget_id, 'chart_id': chart_id },
                        type: "GET",
                        dataType: "html",
                        cache: false,
