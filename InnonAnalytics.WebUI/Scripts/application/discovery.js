...
var parentid = null;
//This selectedNode is structured treeview select node
...
function update_container(treelist_name) {
    var models = [];
    $('div#' + treelist_name + ' input.chkb:checkbox').each(function () {

        var checkbox = $(this);
        if (checkbox.is(":checked") && !checkbox.is(":disabled")) {
            var row = $(this).closest("tr");
            // console.log(row);
            var grid = $("#" + treelist_name).data("kendoTreeList");
...
$(document).ready(function () {
    ...
    $("#addnewpoints").click(function (e) {        
        ...
        if (selectedNode == null) {
            ...
            //  (dataobject);
            models = update_container("connection_treelist");
